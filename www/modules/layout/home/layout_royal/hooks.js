 ...
 */
App.service('layout_royal', function ($rootScope, HomepageLayout) {
    ...
    service.getTemplate = function() {
        return "modules/layout/home/layout_royal/view.html";
    };
...
App.controller('ROYALController', ['$scope', function($scope)
{
  var royalJS = document.createElement('script');
  royalJS.type = "text/javascript";
  royalJS.src = "modules/layout/home/layout_royal/royal.js";
  royalJS.onload = function() {
    $scope.loadContent();
  };
  document.body.appendChild(royalJS);
}]);
